...
class _UpdateAddressState extends State<UpdateAddress> {
  ...
  @override
  void initState() {
    _buildingNoController.text = widget.data['buildingNo'];
    _streetController.text = widget.data['street'];
    floor = widget.data['floor'];
    department = widget.data['department'];
    _floorController.text = floor > -1 ? widget.data['floor'].toString() : '';
    _departmentController.text =
        department > -1 ? widget.data['department'].toString() : '';
    _moreDescriptionController.text = widget.data['moreDescription'];
    _governorateId = widget.data['governorate']['id'];
    _cityId = widget.data['city']['id'];

    _containingFloor = floor > -1 ? true : false;
    _containingDepartment = department > -1 ? true : false;
    super.initState();
  }
                      ...
                      Flexible(
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            floor = _containingFloor
                                ? int.parse(_floorController.text)
                                : -1;
                            department = _containingDepartment
                            ...
                            Map<String, dynamic> data = {
                              ...
                              'moreDescription':
                                  _moreDescriptionController.text,
                              'governorateId': _governorateId,
                              'cityId': _cityId,
                            };
                            Navigator.of(context).pop();
                            widget.onAddressUpdated(data);
                          },
                          child: Text(
                            'تحديث',
                            textAlign: TextAlign.center,
